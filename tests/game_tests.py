...
# If you need to have any resources created before a test is run, you can do that in setUp()
# In the code below, the set up function does two things:
# i. Registers a user in the testing database
# ii. Seeds the testing database with a game type
